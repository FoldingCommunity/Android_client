...
Java_com_sonymobile_androidapp_gridcomputing_service_ComputeEnvironment_startNodeWithArguments(
        JNIEnv *env,
jobject /* this */,
...
/*extern "C" jint JNICALL
Java_com_sonymobile_androidapp_gridcomputing_service_ComputeEnvironment_stopNode(){
    v8::Local<v8::Context> cont = v8::Context::GetCurrent();
    node::Environment* env = node::GetCurrentEnvironment(cont);
    int node_result = node::Stop(env);
    return node_result;

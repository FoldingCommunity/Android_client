...
public final class PrefUtils {
    ...
    public static float getFloatValue(final String prefFile, final String key, final float defaultvalue) {
        return getSharedPreferences(prefFile).getFloat(key, defaultvalue);
    }

...
public final class ConditionsHandler extends BroadcastReceiver implements AssetCopyListener {
     ...
     */
    public static float MIN_BATTERY_LEVEL;

    /**
     * Battery level threshold during job execution.
     */
    public static float MIN_BATTERY_LEVEL_EXEC_THRESHOLD;
    /**
     ...
     */
    public static float MIN_BATTERY_LEVEL_PLATEAU;
    /**
     ...
     */
    public static float MIN_BATTERY_FORCE_KILL;
    /**
    ...
    private ConditionsHandler() {
        ...
        MIN_BATTERY_LEVEL_PLATEAU = MIN_BATTERY_LEVEL - .3F;
    }
    ...
    public boolean checkChargerCondition() {
        return isAcCharging() || isWirelessCharging() || isUSBCharging();
    }

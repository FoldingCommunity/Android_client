...
var AWS_ENDPOINT = 'https://monitoring.us-east-2.amazonaws.com';
...
try {
  console.log(__dirname + '/aws-credentials-analytics.json');
  AWS.config.loadFromPath('/home/ec2-user/.aws/credentials');
} catch (e) {
